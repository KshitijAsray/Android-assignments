...
public class Logic
    ...
    {
        double peri = base+height+(Math.sqrt((Math.pow(base,2.0)+(Math.pow(height,2.0)))));
        return peri;
    }
    public static double boxVolume(double length, double width, double depth)
    {
        double boxvol = length*width*depth;
        return boxvol;
    }
    public static double boxSurfaceArea(double length, double width, double depth)
    {
        double area = 2*((length*width)+(length*depth)+(width*depth));
        return area;
    }
    public static double sphereVolume(double radius)
    {
        double pi = Math.PI;
        double r = 4.0/3.0;
        double vol = (r*pi*Math.pow(radius,3.0));
        return vol;
    }
    public static double sphereSurfaceArea(double radius)
    {
        double pi = Math.PI;
        double sur = 4*pi*Math.pow(radius,2.0);
        double sur1 = sur;
        return sur1;
    }
